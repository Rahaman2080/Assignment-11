    ...
    return (
        <div>
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content p-5 md:mx-auto flex-col lg:flex-row">
                    <div className="text-center lg:text-left">
                        <h1 className=" text-3xl md:text-5xl font-bold">Login now!</h1>
                        <img src="https://i.ibb.co/KGHdPx9/login.png" className="w-3/4" alt="" />
                    </div>
                    <div className="card flex-shrink-0 w-10/12 md:w-full max-w-sm mx-auto shadow-2xl bg-base-100">
                            ...
                            <div className="form-control">
                                <div className="relative h-10 w-full min-w-[200px]">
                                    <input
                                        type="email"
                                        name="email"
                                        className="peer h-full w-11/12 md:w-full rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-purple-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                        placeholder=" "
                                    />
